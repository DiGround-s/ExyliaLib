...
final class PostgresDialect extends AnsiDialect {
    ...
    @Override
    public @NotNull String autoIncrement() {
        // Not AUTO_INCREMENT, which Postgres has never had. SERIAL would work
        // but is discouraged since 10: it creates a sequence the column does not
        // own, so dropping the column leaves the sequence behind. IDENTITY is
        // the standard spelling and the sequence dies with the table.
