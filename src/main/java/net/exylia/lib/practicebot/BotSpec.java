 ...
 * decides what that means in armour and enchantments. That is the whole point of
 * the mode carrying its own loadout.
 *
...
public record BotSpec(
    ...
    public BotSpec(Player owner, Location spawn, CombatMode mode, Difficulty difficulty, boolean respawn) {
        this(owner, spawn, mode, difficulty, respawn, null, null);
    }
    ...
    public static BotSpec duel(Player owner, Location spawn, CombatMode mode, Difficulty difficulty,
        ...
        return new BotSpec(owner, spawn, mode, difficulty, false, name, skin);
    }
}
