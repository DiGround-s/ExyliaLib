 ...
 * }</pre>
 *
 * <p>A {@link revxrsal.commands.parameter.ParameterType} that suggests through
 * {@code defaultSuggestions()} hangs off the type rather than off this
 * registry, so it filters itself with {@link #matching(String, Collection)}.
 *
 * @since 1.129.0
 */
public final class Suggestions {
    ...
    /**
     * The factory to register on a Lamp builder.
     *
