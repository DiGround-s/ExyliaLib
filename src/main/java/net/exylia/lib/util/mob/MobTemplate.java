 ...
 *                   and {@code %max_health%} are kept current (hits left and hits in
 *                   hits mode), and a {@code <rainbow>} in it turns. Blank for no name
...
public record MobTemplate(@NotNull String id, @NotNull EntityType type, @NotNull String name,
    ...
    /**
     * A template with the vanilla behaviour and look: the shape before 1.195.0.
     *
     * @since 1.192.0
     */
