...
| version-aware bundled menu refresh | `ui/PluginMenus.refreshVersionedDirectory` | `ui/PluginMenus` (`updateVersioned`, `declaredMenuVersion`) | [docs/menus.md](docs/menus.md) | 1.157.0 |
