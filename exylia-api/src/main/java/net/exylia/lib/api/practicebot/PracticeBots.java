 ...
 *
 * <p>The library is the one jar every plugin already sees, so the contract
 * lives there and nowhere else. See {@link net.exylia.lib.api.ExyliaAPI} for the
 * whole of that reasoning and for the generic way in.
 *
 * @since 1.73.0
 */
public final class PracticeBots {
    ...
    public static Optional<PracticeBotService> get() {
        return ExyliaAPI.get(PracticeBotService.class);
    }
