...
| [Packets](packets.md) | Vanish, drawing invisible players, fake blocks, freezing, a fake spectator, silent chest viewing and per-player world borders — packets to one client, nothing on the server | 1.75.0 (`WorldBorders` 1.162.0) |
...
| [Mobs](mobs.md) | Custom mobs from a template — name, equipment, attributes, flags, effects and skills — spawned anywhere, with who hurt them reported on death; storage and payouts stay with the plugin | 1.192.0 |
